...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // fabcoin
        ...
        vSeeds.emplace_back("fabcoin3.dynu.net", false); // Fabcoin mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // fabcoin
        ...
        vSeeds.emplace_back("fabcoin4.dynu.net", false); // Fabcoin testnet
...
public:
    CUnitTestParams()
    {
        ...
        // FABCOIN have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
