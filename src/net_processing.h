...
#ifndef FABCOIN_NET_PROCESSING_H
#define FABCOIN_NET_PROCESSING_H
...
//!!! static constexpr int64_t STALE_CHECK_INTERVAL = 10 * 60; // 10 minutes   //q
static constexpr int64_t STALE_CHECK_INTERVAL = 1.25 * 60; // 1.25 minutes
...
#endif // FABCOIN_NET_PROCESSING_H
